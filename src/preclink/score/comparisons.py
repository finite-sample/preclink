...
from preclink._typing import StringAlgorithm, as_series
...
class NumericComparison:
    ...
    def compare(self, left: pd.Series, right: pd.Series) -> pd.Series:
        ...
        Returns:
            Series of similarity scores between 0 and 1.
        """
        left_num = as_series(pd.to_numeric(left, errors="coerce"))
        right_num = as_series(pd.to_numeric(right, errors="coerce"))
